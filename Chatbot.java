             ...
             "hello", "hey", "good morning", "good afternoon", "good evening", "howdy", "hola", "bonjour", "ciao", "greetings", "salutations", "namaste", "aloha","margherita", "pepperoni", "hawaiian", "vegetarian", "mushroom", "bbq chicken", "meat lover's", "meat lovers", "four cheese", "buffalo chicken", "capricciosa","menu", "option", "select", "choice","possibilit", "item", "list", "food", "card", "dish", "offer", "variet", "plate", "spread", "catalog", "bill","bye","pizza","no", "nope", "nah", "negative", "not at all", "never", "no way", "not really","opening time", "open", "hour", "time", "schedule", "operating hour", "business hour", "when open", "working hour", "availab", "operating time", "open now", "clos", "open today", "open hour", "time", "have"};
              ...
              if(!containsKeyword){
               if (userResp.trim().isEmpty()) {
                   ...
                   if(num==0){
                       System.out.println("It seems you didn't type anything. Please try again!");
                   }
                   else if(num==1){
                       System.out.println("Please enter a response");
                   }
                   else if(num==2){
                       System.out.println("I am sorry, I cannot help unless you tell me what you want");
                   }
                   continue;
               }
               else{
                 ...
                 if(num==0){
                   System.out.println("Sorry, I didn’t quite catch that. Could you please rephrase or clarify?");
                 }
                 else if(num==1){
                   System.out.println("Hmm, I’m not sure I understand. Could you provide more details or ask in a different way?");
                 }
                 else if(num==2){
                   System.out.println("Oops! I’m having trouble processing that. Can you try again with different wording?");
                 }
                 else if(num==3){
                   System.out.println("I’m not certain what you mean. Could you write it out a bit differently?");
                 }
                 else if(num==4){
                   System.out.println("I didn’t quite get that. Could you please clarify your request?");
                 }
               }
             }
 ...
 String[] pizzas = {"menu", "option", "select", "choice","possibilit", "item", "list", "food", "card", "dish", "offer", "variet", "plate", "spread", "catalog", "bill", "have"};
              ...
              String[] greetings = {"hello","hi", "hey", "good morning", "good afternoon", "good evening", "howdy", "hola", "bonjour", "ciao", "greetings", "salutations", "namaste", "aloha"};
                  for(String greeting:greetings){
                     if(userResp.toLowerCase().contains(greeting)){
                        int num=(int)(Math.random()*3);
                        if(num==0){
                           System.out.println("Good morning! I hope you are doing well. Do you want to learn about what pizzas are on the menu or do you want to know about the available times?");
                        }
                        else if(num==1){
                           System.out.println("Hello! How’s everything? Do you want to learn about the timings or the delightful pizza options you can choose from?");
                        }
                        else if(num==2){
                           System.out.println("Hey! Today is such a wonderful day to have a customer like you. Do you want to learn what’s on the pizza menu today, or do you want to know when you can stop by?");
                        }
             ...
             for (String keyword : hour) {
               if (userResp.toLowerCase().contains(keyword)) {
                   ...
                   if(num==0){
                       System.out.println("Our restaurant is open daily from 10:00 AM to 10:00 PM.");
                   }
                   else if(num==1){
                       System.out.println("You can always stop by from 10:00 AM to 10:00 PM.");
                   }
                   break;
               }
             }
              ...
              for(String no:noWords){
                 if(userResp.toLowerCase().contains(no)){
                     int num= (int)(Math.random()*2);
                     if(num==0){
                       System.out.println("Okay! You can always type 'bye' to exit the informational bot");
                     }
                     else if(num==1){
                       System.out.println("Thank you for your feedback. If there is nothing else you would like to ask, you can always type 'bye' to exit the chatbot");
                     }
                 }
             }
